...
export const locucionItems: WorkItem[] = [
  ...
  },
  {
    ...
    description:
      "Locución de spot institucional en reclamo a la pérdida del poder adquisitivo de los no docentes.",
    mediaType: "instagram",
    date: "2024-05-10",
    source: "APUBA",
...
export const redesItems: WorkItem[] = [
  {
    id: "red-1",
    title: "Backstage — Festival Algo Más Que Pogo",
    description: "Recorrida por el backstage del festival Algo Más Que Pogo.",
    mediaType: "instagram",
    date: "2024-09-01",
    source: "Algo más que pogo",
    url: "https://www.instagram.com/reel/DPukPMWkaBY/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==",
    tags: ["festival", "backstage", "AMQP"],
  },
  {
    id: "red-2",
    title: "Entrevista a Ni un Hueso — Festival AMQP",
    description: "Entrevista a la banda Ni un Hueso en el festival Algo Más Que Pogo.",
    mediaType: "instagram",
    date: "2024-09-01",
    source: "Algo más que pogo",
    url: "https://www.instagram.com/reel/C_38QgfSrUX/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==",
    tags: ["festival", "entrevista", "AMQP"],
  },
  {
    id: "red-3",
    title: "Entrevista a Los Jugos Locos — Festival AMQP",
    description: "Entrevista a Los Jugos Locos en el festival Algo Más Que Pogo.",
    mediaType: "instagram",
    date: "2024-09-01",
    source: "Algo más que pogo",
    url: "https://www.instagram.com/reel/C_3PFcpu7uZ/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==",
    tags: ["festival", "entrevista", "AMQP"],
  },
  {
    id: "red-4",
    title: "Entrevista a Por Defecto — Festival AMQP",
    description: "Entrevista a Por Defecto en el festival Algo Más Que Pogo.",
    mediaType: "instagram",
    date: "2024-09-01",
    source: "Algo más que pogo",
    url: "https://www.instagram.com/reel/C_yvluVShwb/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==",
    tags: ["festival", "entrevista", "AMQP"],
  },
  {
    id: "red-5",
    title: "Entrevista a Mel Morales — Festival AMQP",
    description: "Entrevista a Mel Morales en el festival Algo Más Que Pogo.",
    mediaType: "instagram",
    date: "2024-09-01",
    source: "Algo más que pogo",
    url: "https://www.instagram.com/reel/C_x_N2pOBiI/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==",
    tags: ["festival", "entrevista", "AMQP"],
  },
  {
    id: "red-6",
    title: "Cobertura — Festival Algo Más Que Pogo",
    description: "Cobertura general del festival Algo Más Que Pogo.",
    mediaType: "instagram",
    date: "2024-09-01",
    source: "Algo más que pogo",
    url: "https://www.instagram.com/reel/C_tuIEwSSP1/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==",
    tags: ["festival", "cobertura", "AMQP"],
  },
  {
    id: "red-7",
    title: "Visita de Ema Herrera — ETER",
    description: "Cobertura de la visita de Ema Herrera a ETER.",
    mediaType: "instagram",
    date: "2024-09-01",
    source: "ETER",
    url: "https://www.instagram.com/reel/C_lpFDcvYCX/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==",
    tags: ["ETER", "cobertura"],
  },
  {
    id: "red-8",
    title: "Clase de Nano Zyssholtz — ETER",
    description: "Cobertura de la clase que dio el dramaturgo Nano Zyssholtz en ETER.",
    mediaType: "instagram",
    date: "2024-09-01",
    source: "ETER",
    url: "https://www.instagram.com/reel/C_OdnMGvYzI/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==",
    tags: ["ETER", "teatro", "cobertura"],
  },
  {
    id: "red-9",
    title: "Acá Hay un Pacto — Radio Monte Castro",
    description: "Reel del programa Acá Hay un Pacto en Radio Monte Castro.",
    mediaType: "instagram",
    date: "2024-10-01",
    source: "Radio Monte Castro",
    url: "https://www.instagram.com/reel/DCVNKrax_y-/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==",
    tags: ["radio", "programa"],
  },
  {
    id: "red-10",
    ...
    date: "2024-10-01",
    source: "Radio Monte Castro",
    url: "https://www.instagram.com/reel/DBsFoXtRkVI/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==",
    tags: ["radio", "programa"],
  },
];
